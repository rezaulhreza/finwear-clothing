	...
	<div class="hero-wrap js-fullheight" style="background-image: url('images/bg/main-bg.jpg');">
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
				<h3 class="v">finWear Bringing Elegance</h3>
				<h3 class="vr">SINCE 2021</h3>
				<div class="col-md-11 ftco-animate text-center">
					<h1>FinWear</h1>
					<h2><span>Your Virtual Shopping Mall</span></h2>
				</div>
				<div class="mouse">
									...
									<div class="product">
										...
										<div class="text pt-3 px-3">
											...
											<div class="d-flex">
												<div class="pricing">
													<p class="price">
														<span class="price-sale"£ <?php echo number_format($row['price'], 2); ?></span>
													</p>
												</div>
											</div>
										</div>
	...
	">
		<div class="container">
			<div class="row justify-content-center mb-3 pb-3">
				...
				<a href="shop.php"> Summer Sale now </a>
									...
									<div class="testimony-wrap py-4 pb-5">
										<div class="user-img mb-4" style="background-image: url(images/profile/person_4.jpg)">
											<span class="quote d-flex align-items-center justify-content-center">
												<i class="icon-quote-left" style="color:black; margin-left:10px;">We are for you</i>
												
											</span>
										</div>
										<div class="text text-center">
											<p class="name">THOMAS McCarthy</p>
											<ul class="ftco-footer-social list-unstyled mt-5">
												<li class="ftco-animate"><a><span class="icon-twitter"></span></a></li>
												<li class="ftco-animate"><a href=""><span class="icon-facebook"></span></a></li>
												<li class="ftco-animate"><a href="f"><span class="icon-instagram"></span></a></li>
											</ul>
										</div>
									</div>
								</div>
