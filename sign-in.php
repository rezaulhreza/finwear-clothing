    ...
    <div class="container">
      <div class="row block-9">
        ...
        <div class="col-md-7 d-flex">
          <div class="cart-detail bg-white p-3 p-md-4" style=
          "background-image: url('images/login-image.jpg');background-size: cover;
          ...
          display:flex;
            ...
            ">
              Welcome to FinWear Virtual Shopping Mall
            </h3>
